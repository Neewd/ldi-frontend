...
<div class="fixed inset-0 flex z-40">
    ...
    Leaving: "transition ease-in-out duration-300 transform"
        ...
        To: "-translate-x-full"
    -->
    <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-orange-700">
      ...
      <div class="h-0 flex-1 flex flex-col overflow-y-auto">
        ...
        <nav class="px-3 mt-6">
          <div class="space-y-1">
            ...
            <NuxtLink to="/admin" 
                    class=" group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                    :class="{'bg-gray-200 text-gray-900': this.$route.fullPath === '/admin', 'text-gray-700 hover:text-gray-900 hover:bg-gray-50': this.$route.fullPath !== '/admin'}">
              <svg class="mr-3 h-6 w-6" 
                   :class="{'text-gray-500': this.$route.fullPath === '/admin', 'text-gray-400 group-hover:text-gray-500': this.$route.fullPath !== '/admin'}"
            ...
            <NuxtLink to="/admin/currencies" 
                        class="group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                        :class="{'bg-gray-200 text-gray-900': this.$route.fullPath === '/admin/currencies', 'text-gray-700 hover:text-gray-900 hover:bg-gray-50': this.$route.fullPath !== '/admin/currencies'}">
                <svg class="group-hover:text-gray-500 mr-3 h-6 w-6" 
                        :class="{'text-gray-500': this.$route.fullPath === '/admin/currencies', 'text-gray-400 group-hover:text-gray-500': this.$route.fullPath !== '/admin/currencies'}"
            ...
            <NuxtLink to="admin/calendars" href="#" class="text-gray-700 hover:text-gray-900 hover:bg-gray-50 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
...
<div class="bg-white flex-1 overflow-auto focus:outline-none" tabindex="0">
<div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
    ...
    <div class="ml-4 flex items-center md:ml-6">
        ...
        <div @click="profileDashboardOpen = !profileDashboardOpen">
            ...
            >
                <div v-show="profileDashboardOpen" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
